...
public class CTLR {
	...
	// topic-word counts
	private int[][] n_wz; // n_wz[w][z]: number of times word w is generated by topic z in a post
	private int[] sum_nwz; // sum_nwz[z]: total number of times words that are generated by topic z in a post
	
	// topic-word distribution
	private double topicWordDist[][]; // topicWordDist[w][k]: the distribution of word w for topic k. Sum of each words distribution for each k = 1 
