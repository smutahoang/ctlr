...
//				}
	...
	public void output_likelihoodPerplexity() {
		try {
			File f = new File(dataset.path +"/"+nTopics+ "/l_likelihoodPerplexity.csv");
			FileWriter fo = new FileWriter(f);
			fo.write("PostLogLikelihood:"+ postLogLikelidhood + "\n");
			fo.write("PostLogPerplexity:"+ postLogPerplexity + "\n");
			fo.close();
		} catch (Exception e) {
			System.out.println("Error in writing to topical interest file!");
			e.printStackTrace();
