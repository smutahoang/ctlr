...
public class MultithreadCTLR {
	...
	public static int[] sum_nzu = null; // sum_nzu[u] total number of topics that are
									// observed in posts by user u

	// topic-word counts
	public static  int[][] n_zw = null; // n_wz[z][w]: number of times word w is
								// generated by topic z in a post
	public static  int[] sum_nzw = null; // sum_nwz[z]: total number of times words that
	...
	public static double[][] optTopicWordDist = null; // optimized topicWordDist[k][w]
	...
	private static void getThreadIndexes() {
	 ...
	 * @return
	 */
	private static double getLikelihood() {
		// to be written
	 ...
	 */
	private static void altOptimize_topics() {
	...
	public static void init() {
		alpha = nTopics/50;// prior for users' interest
	...
	public static void output_topicWord() {
		try {
	...
	private static void outputPostTopicTopWords(int k) {
		try {
	...
	public static void output_topicInterest() {
		try {
	...
	public static void output_authority() {
		try {
